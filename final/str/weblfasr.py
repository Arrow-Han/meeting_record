...
class RequestApi(object):
    ...
    def all_api_request(self):
        ...
        while True:
            ...
            time.sleep(20)
        # 5 . 获取结果
        return_result = self.get_result_request(taskid=taskid)
...
if __name__ == '__main__':
    api = RequestApi(appid="2d4d725a", secret_key="ae4b0a67dfcf8a06a8e63c639eaeeab9", upload_file_path=r"../../docu/test_video.mp3")
    api.all_api_request()
